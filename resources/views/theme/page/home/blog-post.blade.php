<section class="relative bg-white py-16 md:py-24 overflow-hidden" x-data="{
    currentIndex: 0,
    ...
    <div class="text-center" data-aos="fade-up">
        <h2 class="text-3xl md:text-4xl font-bold text-blue-950">Postingan <span class="text-pink-600">Terbaru</span>
        </h2>
    ...
    <div class="mt-12 text-center relative z-40" data-aos="fade-up">
        <a href="{{ url('/blog') }}" {{-- Jika pakai route name, ganti dengan: route('blog.index') --}}
            class="inline-flex items-center gap-2 px-8 py-3 border-2 border-blue-950 text-blue-950 hover:bg-blue-950 hover:text-white font-bold text-xs uppercase tracking-wider rounded-full transition duration-300 group shadow-sm">
            Lihat Semua Postingan
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
                stroke="currentColor" class="w-4 h-4 transform group-hover:translate-x-1 transition duration-200">
