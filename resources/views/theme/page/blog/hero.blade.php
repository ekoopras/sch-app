<section
    class="relative bg-blue-950 w-full min-h-[50vh] md:min-h-[40vh] flex items-center justify-center pt-[15vh] overflow-hidden">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-10 items-center">
            ...
            <div data-aos="fade-right">
                ...
                <nav class="flex items-center gap-2 text-pink-500 mb-6 font-semibold tracking-widest uppercase text-xs">
                    ...
                    <span class="text-white">Blog & Berita</span>
                </nav>

                <h1 class="text-4xl md:text-6xl font-extrabold text-white leading-tight md:leading-[1.1]">
                    Jendela Informasi <br>
                    <span class="text-yellow-300">Seputar SPENSATA</span>
                </h1>

                <p class="text-blue-100/80 mt-6 text-lg max-w-xl leading-relaxed">
                    Temukan kabar terbaru, prestasi siswa, informasi akademik, dan artikel inspiratif langsung dari
                    lingkungan SMPN 1 Tasikmadu.
                </p>
            </div>

            {{-- Aksen Kanan: Animasi Buku/Informasi --}}
            <div class="hidden xl:flex justify-end" data-aos="fade-left">
                <div class="relative">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        {{-- Icon News/Paper --}}
                        <svg class="w-32 h-32 text-yellow-300 opacity-20" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
...
<div class="relative w-full overflow-hidden leading-[0] bg-blue-950 -mt-1">
    {{-- Background Wave diubah ke bg-white agar menyambung dengan list blog di bawahnya --}}
